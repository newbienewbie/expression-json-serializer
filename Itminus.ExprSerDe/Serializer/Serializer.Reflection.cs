...
namespace Itminus.ExprSerializer
{
    ...
    {
        private static readonly Dictionary<Type, (string, string, Type[])> TypeCache = new Dictionary<Type, (string, string, Type[])>();
            ...
            if (type == null) {
                ...
                if (!TypeCache.TryGetValue(type, out tuple)) {
                    ...
                    if (type.IsGenericType) {
                        ...
                        tuple = ( def.Assembly.FullName, def.FullName, type.GetGenericArguments() );
                    }
                    else {
                        tuple = ( assemblyName, type.AssemblyQualifiedName, null);
                    }
